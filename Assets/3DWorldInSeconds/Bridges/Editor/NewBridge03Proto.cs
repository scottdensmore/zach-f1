...
{
    public class NewBridge03Proto : MonoBehaviour
    {
        [MenuItem("Tools/3D World In Seconds/New Humpback Bridge (prototype)")]
        public static void Set()
        {
            TagCreatorProto.CreateBridgeTag();
            GameObject bridgeObject = new GameObject("New Humpback Bridge");
            bridgeObject.tag = "bridge";
            bridgeObject.AddComponent<Bridge03Proto>();
